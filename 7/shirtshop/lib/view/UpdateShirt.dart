...
class _UpdateShirtState extends State<UpdateShirt> {
  ...
  Widget build(BuildContext context) {
     return SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Edit Shirt:", style: TextStyle(color: Colors.white),),
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      onTap: (){
                        ...
                        {
                          shirtViewModel.updateShirt(colorController.text, textController.text, data.id);
