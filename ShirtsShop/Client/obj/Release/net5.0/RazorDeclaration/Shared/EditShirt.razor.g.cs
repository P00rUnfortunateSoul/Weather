...
#line hidden
#nullable disable
    public partial class EditShirt : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 40 "C:\Users\Uliana\source\repos\ShirtsShop\ShirtsShop\Client\Shared\EditShirt.razor"
       
    [Parameter]
    public bool IsEditMode { get; set; }

    [Parameter]
    public ShirtsShop.Shared.Shirt EditedShirt { get; set; } = new ShirtsShop.Shared.Shirt();
    ...
    {
        EditedSizeId = EditedShirt.Size.Id;
    }

    async void HandleEdit()
    {
        EditedShirt.Size = null;
        EditedShirt.Size = ShirtService.Sizes.FirstOrDefault(s => s.Id == EditedSizeId);

        JSRuntime.InvokeVoidAsync("console.log", EditedShirt);

        await ShirtService.UpdateShirt(EditedShirt, EditedShirt.Id);
        CancelEdit();
